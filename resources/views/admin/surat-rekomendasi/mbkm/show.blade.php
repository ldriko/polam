...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item">MBKM</div>
    </div>
  </div>

  <div class="section-body">
    <h2 class="section-title">MBKM</h2>
      ...
      <div class="col">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="{{ route('admin.surat-rekomendasi.mbkm.update', $submission->id) }}" method="post">
              @csrf
              <div class="row">
                <div class="col">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <textarea
                      name="{{ Auth::guard('employee')->user()->position->AllowedToApprove('mbkm') ? 'note':'' }}"
                      rows="20"
                      class="form-control"
                      {{ $submission->isAvailableToApproved && Auth::guard('employee')->user()->position->AllowedToApprove('mbkm') && !$submission->rejected_at ? '':'disabled' }}
              ...
              <div class="row justify-content-end">
                @if($submission->isAvailableToRejected(Auth::guard('employee')->user()->position, 'mbkm'))
                ...
                @if(!$submission->rejected_at)
                  ...
                  @if($submission->isAvailableToApproved && Auth::guard('employee')->user()->position->AllowedToApprove('mbkm'))
                    <div class="col-4 text-right">
