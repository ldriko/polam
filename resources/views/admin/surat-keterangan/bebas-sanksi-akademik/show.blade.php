...
<section class="section">
  ...
  <div class="section-body">
    <h2 class="section-title">Bebas Sanksi Akademik</h2>
      ...
      <div class="col">
            ...
            <div class="row">
              ...
              <div class="col">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{ $data->birth_place }}" disabled>
                </div>
              </div>
              <div class="col">
                <div class="form-group">
                  <label>Tanggal Lahir</label>
                  <input type="text" class="form-control" value="{{ $data->birth_date }}" disabled>
                </div>
              </div>
            </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="{{ route('admin.surat-keterangan.bebas-sanksi-akademik.update', $submission->id) }}" method="post">
              @csrf
              <div class="row">
                <div class="col">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <textarea
                      name="{{ Auth::guard('employee')->user()->position->AllowedToApprove('bebas-sanksi-akademik') ? 'note':'' }}"
                      rows="20"
                      class="form-control"
                      {{ $submission->isAvailableToApproved && Auth::guard('employee')->user()->position->AllowedToApprove('bebas-sanksi-akademik') && !$submission->rejected_at ? '':'disabled' }}
              ...
              <div class="row justify-content-end">
                @if($submission->isAvailableToRejected(Auth::guard('employee')->user()->position, 'bebas-sanksi-akademik'))
                ...
                @if(!$submission->rejected_at)
                  ...
                  @if($submission->isAvailableToApproved && Auth::guard('employee')->user()->position->AllowedToApprove('bebas-sanksi-akademik'))
                    <div class="col-4 text-right">
