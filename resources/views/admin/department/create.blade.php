              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <input type="text" name="short_name" class="form-control" placeholder="" required value="{{ old('short_name') }}">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <input type="text" name="url" class="form-control" placeholder="" value="{{ old('url') }}">
                  </div>
                </div>
                <div class="col">
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <input type="text" name="description" class="form-control" placeholder="" required value="{{ old('description') }}">
                  </div>
                </div>
              </div>
