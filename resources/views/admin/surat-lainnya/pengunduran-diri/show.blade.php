...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item">Pengunduran Diri</div>
    </div>
  </div>

  <div class="section-body">
    <h2 class="section-title">Pengunduran Diri</h2>
      ...
      <div class="col">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="{{ route('admin.surat-lainnya.pengunduran-diri.update', $submission->id) }}" method="post">
              @csrf
              <div class="row">
                <div class="col">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <textarea
                      name="{{ Auth::guard('employee')->user()->position->AllowedToApprove('pengunduran-diri') ? 'note':'' }}"
                      rows="20"
                      class="form-control"
                      {{ $submission->isAvailableToApproved && Auth::guard('employee')->user()->position->AllowedToApprove('pengunduran-diri') && !$submission->rejected_at ? '':'disabled' }}
              ...
              <div class="row justify-content-end">
                @if($submission->isAvailableToRejected(Auth::guard('employee')->user()->position, 'pengunduran-diri'))
                ...
                @if(!$submission->rejected_at)
                  ...
                  @if($submission->isAvailableToApproved && Auth::guard('employee')->user()->position->AllowedToApprove('pengunduran-diri'))
                    <div class="col-4 text-right">
