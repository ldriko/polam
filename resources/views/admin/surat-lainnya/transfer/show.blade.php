  ...
  <div class="section-body">
    ...
    <div class="row">
      <div class="col">
        ...
        <div class="card">
          <div class="card-header">
            <h4>Informasi Kampus Tujuan</h4>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col">
                <div class="form-group">
                  <label>Universitas / Institut</label>
                  <input type="text" class="form-control" value="{{ $data->university }}" disabled>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{ $data->faculty }}" disabled>
                </div>
              </div>
              ...
              <div class="col">
                <div class="form-group">
                  <label>Program Studi</label>
                  <input type="text" class="form-control" value="{{ $data->new_department }}" disabled>
                </div>
              </div>
            </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="{{ route('admin.surat-lainnya.transfer.update', $submission->id) }}" method="post">
              @csrf
              <div class="row">
                <div class="col">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <textarea
                      name="{{ Auth::guard('employee')->user()->position->AllowedToApprove('transfer') ? 'note':'' }}"
                      rows="20"
                      class="form-control"
                      {{ $submission->isAvailableToApproved && Auth::guard('employee')->user()->position->AllowedToApprove('transfer') && !$submission->rejected_at ? '':'disabled' }}
              ...
              <div class="row justify-content-end">
                @if($submission->isAvailableToRejected(Auth::guard('employee')->user()->position, 'transfer'))
                ...
                @if(!$submission->rejected_at)
                  ...
                  @if($submission->isAvailableToApproved && Auth::guard('employee')->user()->position->AllowedToApprove('transfer'))
                    <div class="col-4 text-right">
