...
<body style="width: 21cm; height: 29cm; margin: 0px; position: relative;">
    ...
    <div class="px-50 py-50">
        ...
        <section class="px-50">
            ...
            <p class="text-justify lh-1-5 text-indent">Dengan ini kami menyatakan bahwa yang bersangkutan benar-benar terdaftar sebagai mahasiswa aktif pada program studi <span class="bold">{{ $data['department'] }}</span>, Fakultas Ilmu Komputer tahun akademik <span class="bold">{{ $academicYear }}</span>.</p>
