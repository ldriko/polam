...
<section class="section">
  ...
  <div class="section-body">
    <h2 class="section-title">Penelitian Mata Kuliah</h2>
      ...
      <div class="col">
            ...
            <div class="row">
              <div class="col">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{ $data->subject_name }}" disabled>
                </div>
              </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="{{ route('admin.surat-pengantar.penelitian-matkul.update', $submission->id) }}" method="post">
              @csrf
              <div class="row">
                <div class="col">
                  <div class="form-group">
